...
export default async function DashboardLayout({
  ...
  const adminEmail = headerList.get('X-Admin-Email') || 'admin@libraryos-lms.vercel.app'
...
function LogoutButton() {
  return (
    <form action="/api/admin/logout" method="POST">
      <button 
        type="submit"
        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-red-500/10 hover:text-red-400 transition-all text-sm font-medium"
      >
